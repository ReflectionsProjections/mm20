...
public class Stats_ {
    ...
    public Stats_ withSpy(Long spy) {
        this.spy = spy;
        return this;
    }
    ...
    public Stats_ withTheorize(Long theorize) {
        this.theorize = theorize;
        return this;
    }
    ...
    public Stats_ withRefactor(Long refactor) {
        this.refactor = refactor;
        return this;
    }
    ...
    public Stats_ withCodingProwess(Long codingProwess) {
        this.codingProwess = codingProwess;
        return this;
    }
    ...
    public Stats_ withTest(Long test) {
        this.test = test;
        return this;
    }
    ...
    public Stats_ withOptimize(Long optimize) {
        this.optimize = optimize;
        return this;
    }
