...
class AI(object):
    ...
    # @param amount
    #   The amount to (in-/de-)crement the attribute
    ...
    ## Make a seralible repesentaion of the AI
    # @return
...
class TestAI(unittest.TestCase):
    ...
    def test_changeAttribute(self):
        ...
        # Test changeAttribute's zero-clamping
        # (i.e. attributes should have a minimum value of 0)
